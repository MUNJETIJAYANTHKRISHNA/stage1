            ...
            <main className="settings-main-content">
                <form onSubmit={handleSubmit} className="settings-form">
                    <div className="form-group">
                        ...
                        <input type="text" id="name" defaultValue="Jayanth Krishnam" required />
                    </div>
                    
                    <div className="form-group">
                        <label htmlFor="email"><FaEnvelope /> Email Address</label>
                        <input type="email" id="email" defaultValue="jayanthkrishnam@gmail.com" required disabled />
                        <small>Email is used for login and cannot be changed here.</small>
                    </div>
                    
                    <div className="form-group">
                        <label htmlFor="location"><FaMapMarkerAlt /> Location</label>
                        <input type="text" id="location" defaultValue="Bengaluru, Karnataka" />
                    </div>
